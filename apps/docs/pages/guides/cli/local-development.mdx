...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Create your first migration file">
      ...
      To get started, generate a [new migration](https://www.supabase.cc/docs/reference/cli/supabase-migration-new) to store the SQL needed to create our `employees` table
