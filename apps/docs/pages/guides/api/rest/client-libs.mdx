...
| --------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------- |
| Javascript/Typescript | [supabase-js](https://github.com/supabase/supabase-js)     | [Docs](https://www.supabase.cc/docs/reference/javascript/introduction) |
| Dart/Flutter          | [supabase-dart](https://github.com/supabase/supabase-dart) | [Docs](https://www.supabase.cc/docs/reference/dart/introduction)       |

## Community Libraries

| `Language`              | `Source Code`                                                                    | `Documentation`                                                 |
| ----------------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| C#                      | [supabase-csharp](https://github.com/supabase-community/supabase-csharp)         | [Docs](https://www.supabase.cc/docs/reference/csharp/introduction) |
...
| Python                  | [supabase-py](https://github.com/supabase-community/supabase-py)                 | [Docs](https://www.supabase.cc/docs/reference/python/initializing) |
