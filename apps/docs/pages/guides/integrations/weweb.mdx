...
By [making custom queries to Supabase](https://www.supabase.cc/docs/reference/javascript/select):
...
> If you have enabled Row-Level Security in Supabase, make sure you have also [added a Policy](https://www.supabase.cc/docs/learn/auth-deep-dive/auth-policies) that allows users to read the data in the table. Otherwise, WeWeb won't be able to get the data.
...
Supabase allows you to [enable Row-Level Security](https://www.supabase.cc/docs/learn/auth-deep-dive/auth-row-level-security) for each of your tables:
...
- [write SQL policies in Supabase](https://www.supabase.cc/docs/learn/auth-deep-dive/auth-policies).
...
Learn more about [managing user data in Supabase](https://www.supabase.cc/docs/guides/auth/managing-user-data).
