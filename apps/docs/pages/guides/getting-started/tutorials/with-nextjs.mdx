...
First, [generate type definitions from your database using the Supabase CLI](https://www.supabase.cc/docs/guides/database/api/generating-types) to `../utils/database.types`.
