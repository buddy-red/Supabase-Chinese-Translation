...
[Try supabase-js V2](https://www.supabase.cc/docs/reference/javascript/)<br/>
[Try flutter-supabase V1](https://www.supabase.cc/docs/reference/dart)
...
Next.js Conf raised the bar for dev conferences. We had the honor of being a Gold Sponsor, so we revamped our [Next.js Quickstart guide](https://www.supabase.cc/docs/guides/with-nextjs) to include our pre-built Auth UI and [Auth Helpers.](https://www.supabase.cc/docs/guides/auth/auth-helpers/nextjs)

And Next.js 13 was announced! Making it extremely easy to fetch and cache data from our [Serverless API](https://www.supabase.cc/docs/guides/database/api). So we put together an [example to try it out](https://github.com/supabase/supabase/tree/master/examples/caching/with-nextjs-13).
...
[Read the docs](https://www.supabase.cc/docs/guides/auth/server-side-rendering).
...
[Learn how it works](https://www.supabase.cc/docs/guides/database/testing).
