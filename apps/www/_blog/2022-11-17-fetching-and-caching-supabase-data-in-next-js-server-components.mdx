...
> For automatically adding types to the Supabase client, check out [how to generate types](https://www.supabase.cc/docs/reference/javascript/typescript-support).
...
> Again, check out [how to generate types](https://www.supabase.cc/docs/reference/javascript/typescript-support) to add proper typing for Post.
...
- [Next.js Quickstart](https://www.supabase.cc/docs/guides/with-nextjs)
