...
We are making another enterprise feature available for all of our users. Our Prometheus-compatible metrics endpoint gives you granular insights on the health and status of your projects, allowing for real-time monitoring, debugging, and alerting for all. [Read the docs](https://www.supabase.cc/docs/guides/platform/metrics).

[![realtime](/images/blog/2022-may/prometheus.png)](https://www.supabase.cc/docs/guides/platform/metrics)
