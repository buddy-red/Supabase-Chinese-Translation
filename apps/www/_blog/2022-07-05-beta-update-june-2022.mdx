...
It's here! Now you can create a project from the Supabase CLI. We will be extending the CLI with more features to manage your project, so stay tuned! [See the doc](https://www.supabase.cc/docs/reference/cli/supabase-projects-create).
