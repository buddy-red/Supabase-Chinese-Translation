...
- [C# Client Library](https://www.supabase.cc/docs/reference/csharp/)
- [Python Client Library](https://www.supabase.cc/docs/reference/python/initializing)
...
[Read the docs](https://www.supabase.cc/docs/guides/storage/image-transformations#automatic-image-optimisation-webp)
...
- Docs: New guide on scheduling functions with pg_cron. [[Guide]](https://www.supabase.cc/docs/guides/functions/schedule-functions)

- Edge Functions: You can now download source codes of deployed edge functions from the CLI. [[Doc]](https://www.supabase.cc/docs/reference/cli/supabase-functions-download)
