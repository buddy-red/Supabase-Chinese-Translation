...
[Slack](https://www.supabase.cc/docs/guides/auth/social-login/auth-slack),
[Spotify](https://www.supabase.cc/docs/guides/auth/social-login/auth-spotify), and
[MessageBird](https://www.supabase.cc/docs/guides/auth/phone-login/messagebird) phone logins.
...
[Docs](https://www.supabase.cc/docs/reference/javascript/initializing#api-schemas).
...
Learn about PostgreSQL Functions. [Docs](https://www.supabase.cc/docs/guides/database/functions).
...
Learn about all the exciting features of Auth within Supabase. [Docs](https://www.supabase.cc/docs/guides/auth).
...
Learn more about the power of PostgREST for RESTful APIs. [Docs](https://www.supabase.cc/docs/guides/database/api#restful-api).
...
- Redwood Quickstart: [https://www.supabase.cc/docs/guides/with-redwoodjs](https://www.supabase.cc/docs/guides/with-redwoodjs)
- Expanded Self-hosting: [https://www.supabase.cc/docs/guides/hosting/overview](https://www.supabase.cc/docs/guides/hosting/overview)
- Expanded Auth Reference docs with [serverside functions](https://www.supabase.cc/docs/reference/javascript/auth-api-deleteuser).
- "Before you launch" checklist: [https://www.supabase.cc/docs/going-into-prod](https://www.supabase.cc/docs/going-into-prod)
