...
- A new [guide](https://www.supabase.cc/docs/guides/auth/auth-captcha) to add captcha to your sign-in, sign-up, and password reset forms
...
- Added [docs](https://www.supabase.cc/docs/guides/storage-cdn) for how caching works in Supabase
