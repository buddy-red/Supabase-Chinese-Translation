...
Today we are moving the Supabase CLI v1 out of beta. The Supabase CLI is capable of managing database migrations and generating TypeScript types. Follow these [install instructions](https://www.supabase.cc/docs/guides/cli) to get started.

In addition, we are releasing a Management API (in beta). The Management API is a REST API that allows you to manage organizations, projects, Edge Functions, and more. You can read the [API docs](https://www.supabase.cc/docs/reference/api) or interact with the Management API from the Supabase CLI v1.
...
View the [Supabase CLI docs](https://www.supabase.cc/docs/reference/cli) for the full list of available commands.
...
Check out the [API docs](https://www.supabase.cc/docs/reference/api) to browse all the functionality added so far.
