...
Now we can load more tickets based on the current offset. We'll use the [range](https://www.supabase.cc/docs/reference/javascript/range) method from the supabase-js library to easily work with the pagination logic.
