...
- [Keycloak](https://www.supabase.cc/docs/guides/auth/social-login/auth-keycloak) ([@fspijkerman](https://github.com/fspijkerman))
- [Notion](https://www.supabase.cc/docs/guides/auth/social-login/auth-notion) ([@zernonia](https://github.com/zernonia))
- [Zoom](https://www.supabase.cc/docs/guides/auth/social-login/auth-zoom) ([@devkiran](https://github.com/devkiran))
- [WorkOS](https://www.supabase.cc/docs/guides/auth/auth-workos) ([@bnjmnt4n](https://github.com/bnjmnt4n))
...
- [Vonage](https://www.supabase.cc/docs/guides/auth/phone-login/vonage) ([@devkiran](https://github.com/devkiran))
