...
-   [Firebase Auth Migration](https://www.supabase.cc/docs/guides/migrations/firebase-auth)
-   [Firestore Data Migration](https://www.supabase.cc/docs/guides/migrations/firestore-data)
-   [Firebase Storage Migration](https://www.supabase.cc/docs/guides/migrations/firebase-storage)
-   [Migrate from Heroku to Supabase](https://www.supabase.cc/docs/guides/migrations/heroku)
...
-   A new guide showing how to combine Supabase and Directus. [Guide](https://www.supabase.cc/docs/guides/integrations/directus)
