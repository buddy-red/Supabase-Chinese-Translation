...
Among the many open-source relational databases available, [PostgreSQL](https://www.supabase.cc/docs/guides/database/introduction) is a popular choice among developers.
