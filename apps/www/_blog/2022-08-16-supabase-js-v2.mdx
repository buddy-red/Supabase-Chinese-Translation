...
<a href="https://www.supabase.cc/docs/reference/javascript">Check the updated docs</a> and <a href="https://www.supabase.cc/docs/reference/javascript/v1/upgrade-guide">migration guide</a>.
...
[type generators](https://www.supabase.cc/docs/reference/cli/usage#supabase-gen-types-typescript) to the CLI.
...
[Migration guide](https://www.supabase.cc/docs/reference/javascript/v1/upgrade-guide)
...
- [v2 Documentation](https://www.supabase.cc/docs/reference/javascript)
- [Migration guide](https://www.supabase.cc/docs/reference/javascript/v1/upgrade-guide)
