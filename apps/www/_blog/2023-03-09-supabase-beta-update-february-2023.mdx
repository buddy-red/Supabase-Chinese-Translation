...
[Ask Clippy.](https://www.supabase.cc/docs)
...
[Check the docs.](https://www.supabase.cc/docs/reference/cli/supabase-functions-serve)
...
- **Database**: supabase-js now infers the response type from your query. If the inferred type is incorrect, you can use `.returns<MyType>()` to override it. [Doc](https://www.supabase.cc/docs/reference/javascript/db-returns)
