...
In order to do this, we will utilize a [Postgres function](https://www.supabase.cc/docs/guides/database/functions) and Postgres trigger.
...
We are using the [stream()](https://www.supabase.cc/docs/reference/dart/stream) method on Supabase SDK to load the messages in realtime.
