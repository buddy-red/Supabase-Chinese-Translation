...
The same Dashboard that you're using on our Platform is now available for [Local Development](https://www.supabase.cc/docs/guides/local-development) 
and [Self-Hosting](https://www.supabase.cc/docs/guides/hosting/overview).
