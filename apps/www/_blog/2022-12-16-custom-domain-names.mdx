...
Instructions for setting up Vanity Subdomains are now available in our [docs](https://www.supabase.cc/docs/guides/platform/custom-domains#vanity-subdomains).
