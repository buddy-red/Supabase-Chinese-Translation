...
- If you want to upgrade an existing project, check out our [Upgrading](https://www.supabase.cc/docs/guides/platform/migrating-and-upgrading-projects#upgrade-your-project) documentation.
