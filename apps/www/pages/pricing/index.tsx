  ...
  const addons = [
    {
      ...
      leftCtaLink: 'https://www.supabase.cc/docs/guides/platform/compute-add-ons',
    ...
    },
    {
      ...
      leftCtaText: 'Documentation',
      leftCtaLink: 'https://www.supabase.cc/docs/guides/platform/custom-domains',
    ...
    },
    {
      ...
      leftCtaText: 'Documentation',
      leftCtaLink: 'https://www.supabase.cc/docs/guides/platform/backups',
      rightCtaText: 'See Pricing breakdown',
      rightCtaLink: 'http://',
    },
  ]
