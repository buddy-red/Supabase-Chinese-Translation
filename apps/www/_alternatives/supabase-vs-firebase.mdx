...
- It comes with decades of [useful postgres extensions and plug-ins](https://www.supabase.cc/docs/guides/database/extensions).
...
- Auto-generated API - [query your data straight from the client](https://www.supabase.cc/docs/guides/database/api#rest-api-2).
- Realtime - [changes in your data will be streamed directly to your application](https://www.supabase.cc/docs/reference/dart/subscribe).
...
Since Firebase is document based, migrating into a relational database requires you to map your data structure across into a SQL schema. Luckily we’ve built a [handy conversion tool to do it for you](https://www.supabase.cc/docs/guides/migrations/firestore-data).

We also have guides and tools for [migrating Firebase Auth to Supabase Auth](https://www.supabase.cc/docs/guides/migrations/firebase-auth) for [migrating Firebase Storage files to Supabase Storage](https://www.supabase.cc/docs/guides/migrations/firebase-storage).
